...
esri.arcgis = function () {
    /// <summary>esri.arcgis name space.</summary>
};
...
esri.dijit = function () {
    /// <summary>esri.dijit name space.</summary>
};
...
esri.dijit.editing = function () {
    /// <summary>esri.dijit.editing name space.</summary>
};
...
esri.geometry.Point = function (x,y,spatialReference,xyCoord,spatialReference,json,long,lat,point,point) {
    ...
    /// </signature>
    /// <signature>
    /// <summary>Create a point object and&nbsp;initialize&nbsp;it with an array containing longitude and latitude values.&nbsp;</summary>
...
esri.layers = function () {
    /// <summary>esri.layers name space.</summary>
};
...
esri.symbol.TextSymbol = function (text,font,color,json,text) {
    /// <signature>
...
esri.tasks = function () {
    /// <summary>esri.tasks name space.</summary>
};
...
esri.toolbars = function () {
    /// <summary>esri.toolbars name space.</summary>
};
...
esri.virtualearth = function () {
    /// <summary>esri.virtualearth name space.</summary>
};
